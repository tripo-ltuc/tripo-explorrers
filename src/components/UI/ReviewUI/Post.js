          ...
          <Card.Body className='main-body'>
              ...
              {user.email === this.props.item.userEmail && (
                <Card.Body>
                  <Button
                    variant='danger'
                    style={{ marginRight: '1%' }}
                    onClick={() => this.props.deletePost(this.props.item._id)}
                  >
                  ...
                  <Button
                    variant='success'
                    onClick={() =>
                      this.props.updatePost(this.props.item._id, this.props.idx)
                    }
                  >
            ...
            <Card.Body>
              <Card.Body>
                <Form
                  onSubmit={event =>
                    this.commentHandler(event, this.props.item._id)
                  }
                >
                  <FloatingLabel
                  ...
                  <Button
                    type='submit'
                    style={{ marginTop: '10px', marginLeft: '85%' }}
                  >
                    <FontAwesomeIcon icon={faCommentDots} fixedWidth /> Add
                    Comment
                  </Button>
                </Form>
              </Card.Body>
