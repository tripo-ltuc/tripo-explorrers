                    ...
                    <li style="width: 270px; float: left; display: block;">
                        <article class="box">
                            ...
                            <div class="details"> <span class="price"><small>avg/night</small>$188</span>
                                ...
                                <div class="action"> <a class="hotel-button btn-small" href="#">BOOK</a> <a class="hotel-button btn-small yellow popup-map" href="#" data-box="48.856614, 2.352222">VIEW ON MAP</a> </div>
                            </div>
                        </article>
                    </li>
                    <li style="width: 270px; float: left; display: block;">
